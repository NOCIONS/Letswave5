function [ST] = LW_MLR(header,data,channel_idx,time_interval,num_peak,peak_interval,direction)
% LW_MLR
% Perform single trial analysis using multiple linear regression
%
% Inputs
% - header : LW5 header
% - data : LW5 data
...
% - [ST] = LW_MLR(header,data,16,[0 0.5],2,[0.05 0.15;0.15 0.25],{'negative','positive'});
%
% Outputs
