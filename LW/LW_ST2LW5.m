function [out_header,out_data,regressor_header,regressor_data] = LW_ST2LW5(header,data,ST)
% LW_ST2LW5
...
regressor_header.history(i).description='LW_ST2LW5';
...
for i=1:length(ST.regressor);
    regressor_data(1,1,i*2,1,1,:)=ST.regressor{i}(:,1);
    regressor_data(1,1,(i*2)+1,1,1,:)=ST.regressor{i}(:,2);
end;
