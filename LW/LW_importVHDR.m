function [header,data] = LW_importVHDR(filename);
...
header.tags={};
header.history(1).description='LW_importVHDR';
header.history(1).date=date;
header.history(1).index=filename;
header.datasize=[1 hdr.nChans 1 1 1 hdr.nSamples];
