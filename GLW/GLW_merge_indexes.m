function varargout = GLW_merge_indexes(varargin)
% GLW_merge_indexes MATLAB code for GLW_merge_indexes.fig
%
% Author : 
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_merge_indexes_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_merge_indexes_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_merge_indexes is made visible.
function GLW_merge_indexes_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_merge_indexes (see VARARGIN)
% Choose default command line output for GLW_merge_indexes
...
function varargout = GLW_merge_indexes_OutputFcn(hObject, eventdata, handles) 
...
update_status.function(update_status.handles,'*** Merging indices.',1,0);
%set selected inputfiles
selectedfiles=get(handles.listbox2,'String');
[p n e]=fileparts(selectedfiles{1});
...
for filepos=2:length(selectedfiles);
    ...
    %process
    update_status.function(update_status.handles,'Merging indices.',1,0);
    [header1,data1]=LW_merge_indexes(header1,data1,header2,data2);
end;
LW_save([p filesep get(handles.outputedit,'String')],[],header1,data1);
