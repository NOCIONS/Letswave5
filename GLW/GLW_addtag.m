function varargout = GLW_addtag(varargin)
% GLW_addtag MATLAB code for GLW_butterhigh.fig
%
% Author : 
% Andr? Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_addtag_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_addtag_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GLW_addtag_OpeningFcn(hObject, eventdata, handles, varargin)
...
set(handles.filebox,'Userdata',varargin{3});
axis off;
...
function varargout = GLW_addtag_OutputFcn(hObject, eventdata, handles) 
...
update_status.function(update_status.handles,'*** Adding tags',1,0);
%loop through files
for filepos=1:length(inputfiles);
    ...
    %add tag
    tag=get(handles.tagedit,'String');
    update_status.function(update_status.handles,['Adding tag : ',tag],1,0);
    header=LW_addtag(header,tag);
