function varargout = GLW_butternotch(varargin)
% GLW_butternotch MATLAB code for GLW_butternotch.fig
%
% Author : f
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_butternotch_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_butternotch_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_butternotch is made visible.
function GLW_butternotch_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_butternotch (see VARARGIN)
% Choose default command line output for GLW_butternotch
...
function varargout = GLW_butternotch_OutputFcn(hObject, eventdata, handles) 
...
for filepos=1:length(inputfiles);
    ...
    disp(['*** Zero-phase butterworth notch filter']);
    [header,data]=LW_butternotch(header,data,locutoff1,locutoff2,hicutoff1,hicutoff2,stopband,passband);
