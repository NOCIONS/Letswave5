function varargout = GLW_importLW4MAT(varargin)
% GLW_IMPORTLW4MAT MATLAB code for GLW_importLW4MAT.fig
%
% Author : 
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_importLW4MAT_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_importLW4MAT_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_importLW4MAT is made visible.
function GLW_importLW4MAT_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% Choose default command line output for GLW_importLW4MAT
handles.output = hObject;
% Update handles structure
guidata(hObject, handles);
% UIWAIT makes GLW_importLW4MAT wait for user response (see UIRESUME)
...
function varargout = GLW_importLW4MAT_OutputFcn(hObject, eventdata, handles) 
...
for filepos=1:length(filenames);
    ...
    [header,data]=LW_importLW4MAT(filenames{filepos});
