function varargout = GLW_MLRd(varargin)
% GLW_MLRd MATLAB code for GLW_butterhigh.fig
%
% Author : 
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_MLRd_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_MLRd_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GLW_MLRd_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = GLW_MLRd_OutputFcn(hObject, eventdata, handles) 
...
update_status.function(update_status.handles,'*** Single-trial MLR (with distorsion parameter).',1,0);
%channel_idx
...
for filepos=1:length(inputfiles);
    ...
    %process
    update_status.function(update_status.handles,'Applying the MLRd.',1,0);    
    ST=LW_MLRd(header,data,channel_idx,time_interval,num_peak,peak_interval,direction);
    [header,data,regressor_header,regressor_data]=LW_ST2LW5_MLRd(header,data,ST);
