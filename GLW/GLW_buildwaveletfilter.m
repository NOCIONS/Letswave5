function varargout = GLW_buildwaveletfilter(varargin)
% GLW_buildwaveletfilter MATLAB code for GLW_butterhigh.fig
%
% Author : 
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_buildwaveletfilter_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_buildwaveletfilter_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GLW_buildwaveletfilter_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = GLW_buildwaveletfilter_OutputFcn(hObject, eventdata, handles) 
...
update_status.function(update_status.handles,'*** Build wavelet filter.',1,0);
%loop through files
for filepos=1:length(inputfiles);
    ...
    %process
    update_status.function(update_status.handles,'Building the TF filter.',1,0);
    [header,data]=LW_build_waveletfilter(header,data,channel_idx,frequencyvector,threshold);
