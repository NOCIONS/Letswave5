function varargout = GLW_butterlow(varargin)
% GLW_butterlow MATLAB code for GLW_butterlow.fig
%
% Author : 
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_butterlow_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_butterlow_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_butterlow is made visible.
function GLW_butterlow_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_butterlow (see VARARGIN)
% Choose default command line output for GLW_butterlow
...
function varargout = GLW_butterlow_OutputFcn(hObject, eventdata, handles) 
