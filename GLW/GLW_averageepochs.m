function varargout = GLW_averageepochs(varargin)
% GLW_AVERAGEEPOCHS MATLAB code for GLW_averageepochs.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_averageepochs_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_averageepochs_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GLW_averageepochs_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = GLW_averageepochs_OutputFcn(hObject, eventdata, handles) 
...
operation_string={'average','stdev','median'};
operation=operation_string{get(handles.operation_popup,'Value')};
update_status=get(handles.processbutton,'UserData');
update_status.function(update_status.handles,'*** Average epochs.',1,0);
%loop through files
for filepos=1:length(inputfiles);
    ...
    [header,data]=LW_averageepochs(header,data,operation);
