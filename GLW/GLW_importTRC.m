function varargout = GLW_importTRC(varargin)
% GLW_IMPORTTRC MATLAB code for GLW_importTRC.fig
%
% Author : 
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_importTRC_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_importTRC_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_importTRC is made visible.
function GLW_importTRC_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% Choose default command line output for GLW_importTRC
handles.output = hObject;
% Update handles structure
guidata(hObject, handles);
% UIWAIT makes GLW_importTRC wait for user response (see UIRESUME)
...
function varargout = GLW_importTRC_OutputFcn(hObject, eventdata, handles) 
...
update_status.function(update_status.handles,'*** Importing TRC data.',1,0);
for filepos=1:length(filenames);
    update_status.function(update_status.handles,['Importing : ' filenames{filepos}],1,0);
    [header,data]=LW_importTRC(filenames{filepos});
