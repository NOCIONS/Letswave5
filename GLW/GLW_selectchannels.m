function varargout = GLW_selectchannels(varargin)
% GLW_selectchannels MATLAB code for GLW_selectchannels.fig
%
% Author : 
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_selectchannels_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_selectchannels_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_selectchannels is made visible.
function GLW_selectchannels_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_selectchannels (see VARARGIN)
% Choose default command line output for GLW_selectchannels
...
function varargout = GLW_selectchannels_OutputFcn(hObject, eventdata, handles) 
...
update_status.function(update_status.handles,'*** Selecting channels.',1,0);
...
for filepos=1:length(inputfiles);
    ...
    %process
    update_status.function(update_status.handles,'Parsing channels.',1,0);
