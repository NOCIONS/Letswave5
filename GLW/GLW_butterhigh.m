function varargout = GLW_butterhigh(varargin)
% GLW_butterhigh MATLAB code for GLW_butterhigh.fig
%
% Author : 
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_butterhigh_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_butterhigh_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_butterhigh is made visible.
function GLW_butterhigh_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_butterhigh (see VARARGIN)
% Choose default command line output for GLW_butterhigh
...
function varargout = GLW_butterhigh_OutputFcn(hObject, eventdata, handles) 
...
for filepos=1:length(inputfiles);
    ...
    %locutoff1,locutoff2,bandpass,bandstop
