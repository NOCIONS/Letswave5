function varargout = GLW_stFFT2(varargin)
% GLW_stFFT2 MATLAB code for GLW_stFFT2.fig
%
% Author : 
% André Mouraux
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_stFFT2_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_stFFT2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_stFFT2 is made visible.
function GLW_stFFT2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_stFFT2 (see VARARGIN)
% Choose default command line output for GLW_stFFT2
...
function varargout = GLW_stFFT2_OutputFcn(hObject, eventdata, handles) 
...
update_status.function(update_status.handles,'*** Short term FFT (alternative method).',1,0);
%parfor?
%matlabpool
...
%window
windowsize=str2num(get(handles.windowedit,'String'));
windowtype='hann';
...
for filepos=1:length(inputfiles);
    ...
    %Time lines
    timestart=header.xstart;
    timesize=header.datasize(6);
    timeend=header.xstart+(header.xstep*(header.datasize(6)-1));
    timestep=header.xstep;
    %process
    update_status.function(update_status.handles,'Computing ST-FFT. This may take a while!',1,0);
    tic;
    if parfor_chk==1;
        [header,data]=LW_stFFT2_parfor(header,data,freqstart,freqstep,freqsize,timestart,timestep,timesize,windowsize,windowtype,postproc,average);
    else
        [header,data]=LW_stFFT2(header,data,freqstart,freqstep,freqsize,timestart,timestep,timesize,windowsize,windowtype,postproc,average);
    end;
    toc;
...
function lotimeedit_Callback(hObject, eventdata, handles)
% hObject    handle to lotimeedit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of lotimeedit as text
%        str2double(get(hObject,'String')) returns contents of lotimeedit as a double


% --- Executes during object creation, after setting all properties.
function lotimeedit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to lotimeedit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function hitimeedit_Callback(hObject, eventdata, handles)
% hObject    handle to hitimeedit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of hitimeedit as text
%        str2double(get(hObject,'String')) returns contents of hitimeedit as a double


% --- Executes during object creation, after setting all properties.
function hitimeedit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to hitimeedit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function numtimeedit_Callback(hObject, eventdata, handles)
% hObject    handle to numtimeedit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of numtimeedit as text
%        str2double(get(hObject,'String')) returns contents of numtimeedit as a double


% --- Executes during object creation, after setting all properties.
function numtimeedit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to numtimeedit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
